...
module top_module (
  ...
  `define FLOW_L2 2'h2
  `define FLOW_L3 2'h3
  `define FLOW_SUPPLEMENTAL_OFF 1'b0
  `define FLOW_SUPPLEMENTAL_ON 1'b1

  `define WATER_LEVEL_NO 3'b000
  `define WATER_LEVEL_LOW 3'b001
  `define WATER_LEVEL_MEDIUM 3'b011
  `define WATER_LEVEL_HIGH 3'b111
